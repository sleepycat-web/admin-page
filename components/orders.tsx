...
interface Order {
  ...
  selectedLocation: string; // Add branch to the Order interface
}
 ...
 const filterAndSortOrders = () => {
   ...
   const filtered = orders.filter((order) => {
     return (
       ...
       order.selectedLocation.toLowerCase().includes(searchTermLower) // Add this line to include selectedLocation in search
     );
   });
